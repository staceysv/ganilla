...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--log_all', action='store_true', help='log all images')
        parser.add_argument('--run_name', type=str, default="", help='optional run name')
        parser.add_argument('--from_artifact', type=str, default="", help='optionally load model from artifact')
